 ...
 * 2. Frontend dashboard display (exported to frontend)
 * 
 * DO NOT modify this file without updating both usages!
 */
...
<body>
  <div style="max-width: 800px; margin: 0 auto; padding: 40px; background: white; color: #222;">
    <!-- Header -->
    <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 40px; padding-bottom: 20px; border-bottom: 1px solid #e5e7eb;">
      <div style="display: flex; flex-direction: column;">
        <img src="https://www.planbeau.com/images/logo.png" alt="Planbeau" style="height: 48px; width: auto; margin-bottom: 8px;" />
...
/**
 * Get just the invoice content (without full HTML document wrapper)
 * Used for embedding in dashboard
 */
function generateInvoiceContent(invoice) {
  const fullHTML = generateInvoiceHTML(invoice);
