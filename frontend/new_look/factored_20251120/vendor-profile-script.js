...
// API_BASE_URL and currentUser are provided by index_mobile-script.js
// which is loaded by shared-components.js
...
// Wait for shared components to be ready before initializing
document.addEventListener('sharedComponentsReady', async () => {
    console.log('🚀 Vendor profile page initializing (shared components ready)...');
