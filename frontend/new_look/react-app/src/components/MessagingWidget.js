      ...
      {isOpen && (
        <div className="widget-container" style={{ 
          ...
          <div className="widget-header" style={{
            ...
            color: mainView === 'home' ? '#222' : 'white',
            padding: '20px',
            display: 'flex',
            justifyContent: 'space-between',
            alignItems: 'center',
            borderBottom: mainView === 'home' ? '1px solid #e0e0e0' : 'none'
          }}>
            ...
            <button className="widget-close" onClick={toggleWidget} style={{
              background: mainView === 'home' ? '#f0f0f0' : 'rgba(255,255,255,0.2)',
              border: 'none',
              color: mainView === 'home' ? '#222' : 'white',
              width: '32px',
              height: '32px',
          ...
          <div style={{
            ...
            <button
              ...
              style={{
                ...
                alignItems: 'center',
                gap: '4px',
                color: mainView === 'home' ? '#10b981' : '#717171',
            ...
            <button
              ...
              style={{
                ...
                alignItems: 'center',
                gap: '4px',
                color: mainView === 'messages' ? '#10b981' : '#717171',
                transition: 'color 0.2s',
                position: 'relative'
              }}
            >
            ...
            <button
              ...
              style={{
                ...
                alignItems: 'center',
                gap: '4px',
                color: mainView === 'help' ? '#10b981' : '#717171',
                transition: 'color 0.2s'
              }}
            >
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
