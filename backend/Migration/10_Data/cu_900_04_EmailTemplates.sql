...
BEGIN
    ...
    INSERT [admin].[EmailTemplates] ([TemplateID], [TemplateKey], [TemplateName], [HeaderComponentID], [BodyComponentID], [FooterComponentID], [Subject], [Category], [AvailableVariables], [IsActive], [CreatedAt], [UpdatedAt]) VALUES (12, N'vendor_welcome', N'Vendor Welcome Email', 1, 23, 2, N'Welcome to {{platformName}}, {{vendorName}}!', N'welcome', N'["vendorName","businessName","dashboardUrl","platformName","platformUrl","currentYear","logoUrl"]', 1, CAST(N'2025-01-14T12:00:00.000' AS DateTime), CAST(N'2025-01-14T12:00:00.000' AS DateTime));
    ...
    PRINT 'Inserted 14 records into [admin].[EmailTemplates].';
END
ELSE
BEGIN
