/*
    ...
    Description: Inserts data into [dbo].[EmailTemplates]
...
BEGIN
    ...
    PRINT 'Inserted 7 records into [dbo].[EmailTemplates].';
END
ELSE
BEGIN
    PRINT 'Table [dbo].[EmailTemplates] already contains data. Skipping.';
END
GO
