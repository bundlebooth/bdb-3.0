/*
    ...
    Description: Inserts data into [dbo].[VendorPortfolioImages]
...
PRINT 'Inserting data into [dbo].[VendorPortfolioImages]...';
GO

IF NOT EXISTS (SELECT TOP 1 1 FROM [dbo].[VendorPortfolioImages])
BEGIN
    SET IDENTITY_INSERT [dbo].[VendorPortfolioImages] ON;

    INSERT [dbo].[VendorPortfolioImages] ([PortfolioImageID], [AlbumID], [VendorProfileID], [ImageURL], [CloudinaryPublicId], [CloudinaryUrl], [CloudinarySecureUrl], [CloudinaryTransformations], [Caption], [DisplayOrder], [CreatedAt]) VALUES (1, 1, 138, N'https://res.cloudinary.com/dxgy4apj5/image/upload/v1761609204/venuevue/gnnxmkrzf30z9f5del5g.png', NULL, NULL, NULL, NULL, N'planhive_logo.png', 0, CAST(N'2025-10-27T23:53:29.3733333' AS DateTime2));
    ...
    SET IDENTITY_INSERT [dbo].[VendorPortfolioImages] OFF;

    PRINT 'Inserted 5 records into [dbo].[VendorPortfolioImages].';
END
ELSE
BEGIN
    PRINT 'Table [dbo].[VendorPortfolioImages] already contains data. Skipping.';
END
GO
