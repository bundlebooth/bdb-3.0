/*
    Migration Script: Data - [CategoryQuestions] V2 - Enhanced Questions
    Phase: 1000 - Data
    Script: pb_1000_28_CategoryQuestions_V2.sql
    Description: Updates [admin].[CategoryQuestions] with comprehensive category-specific questions
    
    Execution Order: 28 (runs after original, updates existing data)
