...
BEGIN
    ...
    INSERT [vendors].[VendorFeatureCategories] ([CategoryID], [CategoryName], [CategoryIcon], [DisplayOrder], [IsActive], [CreatedAt], [ApplicableVendorCategories]) VALUES (3, N'Music & Entertainment', N'music', 3, 1, CAST(N'2025-10-24T14:15:15.497' AS DateTime), N'music,entertainment');
    INSERT [vendors].[VendorFeatureCategories] ([CategoryID], [CategoryName], [CategoryIcon], [DisplayOrder], [IsActive], [CreatedAt], [ApplicableVendorCategories]) VALUES (4, N'Catering & Bar', N'utensils', 4, 1, CAST(N'2025-10-24T14:15:15.497' AS DateTime), N'catering,cake');
    ...
    INSERT [vendors].[VendorFeatureCategories] ([CategoryID], [CategoryName], [CategoryIcon], [DisplayOrder], [IsActive], [CreatedAt], [ApplicableVendorCategories]) VALUES (6, N'Event Services', N'party-popper', 6, 1, CAST(N'2025-10-24T14:15:15.497' AS DateTime), N'planner,venue');
    ...
    INSERT [vendors].[VendorFeatureCategories] ([CategoryID], [CategoryName], [CategoryIcon], [DisplayOrder], [IsActive], [CreatedAt], [ApplicableVendorCategories]) VALUES (8, N'Special Features', N'sparkles', 8, 1, CAST(N'2025-10-24T14:15:15.497' AS DateTime), N'venue,entertainment,experiences,catering');
    ...
    INSERT [vendors].[VendorFeatureCategories] ([CategoryID], [CategoryName], [CategoryIcon], [DisplayOrder], [IsActive], [CreatedAt], [ApplicableVendorCategories]) VALUES (10, N'Beauty & Fashion Services', N'sparkles', 10, 1, CAST(N'2025-10-31T13:22:59.923' AS DateTime), N'beauty,fashion');
    ...
    INSERT [vendors].[VendorFeatureCategories] ([CategoryID], [CategoryName], [CategoryIcon], [DisplayOrder], [IsActive], [CreatedAt], [ApplicableVendorCategories]) VALUES (13, N'Experience Services', N'sparkles', 13, 1, CAST(N'2025-10-31T13:23:01.373' AS DateTime), N'experiences');
