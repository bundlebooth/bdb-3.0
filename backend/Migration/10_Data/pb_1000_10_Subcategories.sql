...
BEGIN
    ...
    -- Planning & Coordination subcategories
    INSERT INTO [admin].[Subcategories] (Category, SubcategoryKey, SubcategoryName, Description, DisplayOrder, IsActive)
    VALUES 
    ...
    -- Stationery & Invitations subcategories
    INSERT INTO [admin].[Subcategories] (Category, SubcategoryKey, SubcategoryName, Description, DisplayOrder, IsActive)
    VALUES 
    ...
    -- Experiences & Activities subcategories
    INSERT INTO [admin].[Subcategories] (Category, SubcategoryKey, SubcategoryName, Description, DisplayOrder, IsActive)
    VALUES 
