-- =============================================
-- Stored Procedure: sp_Admin_Get2FASettings
-- Description: Gets 2FA security settings
-- Phase: 600 (Stored Procedures)
-- =============================================
IF EXISTS (SELECT 1 FROM sys.procedures WHERE object_id = OBJECT_ID(N'[dbo].[sp_Admin_Get2FASettings]'))
    DROP PROCEDURE [dbo].[sp_Admin_Get2FASettings];
GO

CREATE PROCEDURE [dbo].[sp_Admin_Get2FASettings]
AS
BEGIN
    SET NOCOUNT ON;
