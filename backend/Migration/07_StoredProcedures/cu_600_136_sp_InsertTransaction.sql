-- =============================================
-- Stored Procedure: sp_InsertTransaction
-- Description: Inserts a new transaction record
-- Phase: 600 (Stored Procedures)
-- =============================================
IF EXISTS (SELECT 1 FROM sys.procedures WHERE object_id = OBJECT_ID(N'[dbo].[sp_InsertTransaction]'))
    DROP PROCEDURE [dbo].[sp_InsertTransaction];
GO
