-- =============================================
-- Stored Procedure: sp_VendorDashboard_GetSetupCounts
-- Description: Gets vendor setup step counts
-- Phase: 600 (Stored Procedures)
-- =============================================
IF EXISTS (SELECT 1 FROM sys.procedures WHERE object_id = OBJECT_ID(N'[dbo].[sp_VendorDashboard_GetSetupCounts]'))
    DROP PROCEDURE [dbo].[sp_VendorDashboard_GetSetupCounts];
GO

CREATE PROCEDURE [dbo].[sp_VendorDashboard_GetSetupCounts]
    @VendorProfileID INT
AS
BEGIN
    SET NOCOUNT ON;
