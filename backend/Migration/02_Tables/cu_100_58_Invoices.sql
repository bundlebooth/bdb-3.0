/*
    ...
    Description: Creates the [dbo].[Invoices] table
...
IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Invoices]') AND type in (N'U'))
BEGIN
...
ELSE
BEGIN
    PRINT 'Table [dbo].[Invoices] already exists. Skipping.';
END
GO
