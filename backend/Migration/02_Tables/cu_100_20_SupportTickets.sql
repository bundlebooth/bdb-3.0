/*
    ...
    Description: Creates the [dbo].[SupportTickets] table
...
PRINT 'Creating table [dbo].[SupportTickets]...';
GO
...
(
    ...
    PRINT 'Table [dbo].[SupportTickets] created successfully.';
END
ELSE
BEGIN
    PRINT 'Table [dbo].[SupportTickets] already exists. Skipping.';
END
GO
