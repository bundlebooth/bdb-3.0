...
INSERT INTO VendorFeatureCategories (CategoryName, CategoryIcon, DisplayOrder) VALUES
('Venue Features', 'building-2', 1),
('Photography & Video', 'camera', 2),
('Music & Entertainment', 'music', 3),
('Catering & Bar', 'utensils', 4),
('Floral & Decor', 'flower-2', 5),
('Event Services', 'party-popper', 6),
('Transportation', 'car', 7),
('Special Features', 'sparkles', 8),
('Event Planning', 'clipboard-list', 9);
GO
